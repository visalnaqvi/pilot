      ...
      {(job.status === 'review' || job.status === 'published') && <>
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm">
          ...
          <div className="mt-6 grid gap-5 md:grid-cols-2">
            ...
            <SelectField label="Visibility" value={visibility} setValue={value => setVisibility(value as typeof visibility)} options={[['private', 'Organisation members'], ['assigned', 'Assigned users'], ['public', 'Public']]} />
          </div>
